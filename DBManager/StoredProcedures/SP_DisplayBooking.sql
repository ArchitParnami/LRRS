...
update lrrsnew.bookings set  booking_status = 'CA' where start_date=CURDATE() and start_time<=CURTIME() and end_time>=CURTIME() and booking_status='NS' and uname = p_uname ;
