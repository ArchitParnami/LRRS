...
BEGIN
update lrrsnew.bookings set booking_status = 'CO' where ((start_date< CURDATE() and (booking_status='AC')) or (start_date=CURDATE() and end_time<CURTIME() and (booking_status='AC'))) and uname = p_uname ;
